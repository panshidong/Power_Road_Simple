...
| weighted_maximin_time_avg_cri_l025 | weighted_sum | Equity via maximin: improve the worst-served zone by maximizing the minimum time-averaged CRI. | 182.525 | -41.3 | 0.380 | +8.3 | 0.316 | 370.276 | 356.276 | 0.500 | 否 |
| weighted_maximin_time_avg_cri_l050 | weighted_sum | Equity via maximin: improve the worst-served zone by maximizing the minimum time-averaged CRI. | 185.462 | -40.3 | 0.295 | -15.9 | 0.460 | 301.017 | 379.315 | 0.468 | 是 |
| weighted_maximin_time_avg_cri_l100 | weighted_sum | Equity via maximin: improve the worst-served zone by maximizing the minimum time-averaged CRI. | 292.388 | -5.9 | 0.282 | -19.7 | 0.539 | 365.272 | 430.867 | 0.461 | 是 |
| guardrail_maximin_time_avg_cri | guardrail | Equity via maximin: improve the worst-served zone by maximizing the minimum time-averaged CRI. | 347.328 | +11.7 | 0.313 | -10.8 | 0.543 | 482.722 | 531.105 | 0.507 | 否 |
