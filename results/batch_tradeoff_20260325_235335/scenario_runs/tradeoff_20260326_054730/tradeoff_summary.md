...
- Result directory: `results/batch_tradeoff_20260325_235335/scenario_runs/tradeoff_20260326_054730`
...
| single_triangle | single | Pure efficiency objective that minimizes resilience-triangle loss. | 805.731 | 0.281 | 0.526 | 1134.975 | 0.460 | No |
...
| single_p90_access_restore | single | Critical-access objective that shortens the time by which 90% of zones regain access. | 791.922 | 0.178 | 0.367 | 739.123 | 0.420 | Yes |
...
| guardrail_gini_restore | guardrail | Triangle minimization with a fairness guardrail. Guardrail on equity:gini_restore. | 794.067 | 0.167 | 0.371 | 855.332 | 0.390 | Yes |
