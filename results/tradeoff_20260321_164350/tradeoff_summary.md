...
- Result directory: `results/tradeoff_20260321_164350`
...
| weighted_maximin_time_avg_cri_l025 | weighted_sum | Weighted trade-off objective. triangle + 0.25 * equity:maximin_time_avg_cri_loss. | 182.525 | 0.380 | 0.316 | 356.276 | 0.500 | No |
| weighted_maximin_time_avg_cri_l050 | weighted_sum | Weighted trade-off objective. triangle + 0.5 * equity:maximin_time_avg_cri_loss. | 185.462 | 0.295 | 0.460 | 379.315 | 0.468 | Yes |
| weighted_maximin_time_avg_cri_l100 | weighted_sum | Weighted trade-off objective. triangle + 1.0 * equity:maximin_time_avg_cri_loss. | 292.388 | 0.282 | 0.539 | 430.867 | 0.461 | Yes |
| guardrail_maximin_time_avg_cri | guardrail | Triangle minimization with a fairness guardrail. Guardrail on equity:maximin_time_avg_cri_loss. | 347.328 | 0.313 | 0.543 | 531.105 | 0.507 | No |
